...
export default function VisualEditor() {
    ...
    const [droppedPictures, setDroppedPictures] = React.useState(initialDestinationSquares);
    ...
    if (source.droppableId === 'source' && destination.droppableId.startsWith('square')) {
        const [removed] = updatedDraggablePictures.splice(source.index, 1);
        const destinationSquareIndex = parseInt(destination.droppableId.split('-')[1], 10) - 1;
        ...
        if (updatedDroppedPictures[destinationSquareIndex].picture) {
          updatedDraggablePictures.push(updatedDroppedPictures[destinationSquareIndex].picture);
        }
      ...
      if (source.droppableId.startsWith('square') && destination.droppableId.startsWith('square')) {
        ...
        updatedDroppedPictures[sourceSquareIndex].picture = updatedDroppedPictures[destinationSquareIndex].picture;
      ...
      if (source.droppableId.startsWith('square') && destination.droppableId === 'source') {
        ...
        const [removed] = updatedDroppedPictures[sourceIndex]?.picture ? [updatedDroppedPictures[sourceIndex].picture] : [];
